    ...
    <main>
        <div class="container">
            <div class="row gutters">
                            ...
                            <div class="cartaeditarperfil">
                                <div class="user-profile">
                                    <div class="user-avatar">
                                        ...
                                        <img src="data:image/jpeg;base64,${foto}" alt="${usuarioNombre}">
                                ...
                                <button type="button" id="submit" name="submit"
                                            class="btn btn-inverse btn-warning">Editar foto de perfil
                                </button>
                                        </div>
                            </div>
                        </div>
                ...
                <!-- aqui indico que es un formularion para cambiar los datos personales -->
